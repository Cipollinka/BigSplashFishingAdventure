export default class Params {
  ...
  static targetDate = '2025-03-07'; // дата закінчення відльожки
  static bodyLin = 'https://splendid-exalted-celebration.space/N8Khb1hV'; // тіло лінки з якою будемо працювати
}
